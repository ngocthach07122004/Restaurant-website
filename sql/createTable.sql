...
add constraint fk_DonGiaoHang_cccdThuNgan foreign key (cccdThuNgan) references NhanVienThuNgan (cccd);
...
alter table DonGiaoHang
add constraint fk_ChiNhanh_cccdQuanTriVien foreign key (cccdQuanTriVien) references QuanTriVien (cccd);
...
add constraint fk_DonMonAn_maChiNhanh foreign key (maChiNhanh) references ChiNhanh (maChiNhanh);

alter table DonMonAn
add constraint fk_DonMonAn_cccdKhachHang foreign key (cccdKhachHang) references KhachHang (cccd);

alter table DonMonAn
add constraint fk_DonMonAn_cccdNhanVienThuNgan foreign key (cccdNhanVienThuNgan) references NhanVienThuNgan (cccd);
...
add constraint fk_PhuongThucThanhToan_maDon foreign key (maDon) references DonMonAn (maDon);
...
alter table DonTaiQuan
add constraint fk_DonTaiQuan_maDon foreign key (maDon) references DonMonAn (maDon);

alter table DonTaiQuan
add constraint fk_DonTaiQuan_cccdPhucVu foreign key (cccdPhucVu) references NhanVienPhucVu (cccd);
...
add constraint fk_DonKhieuNai_maDon foreign key (maDon) references MonAn (maMonAn);

alter table DonKhieuNai
add constraint fk_DonKhieuNai_cccdQuanLy foreign key (cccdQuanLy) references NhanVienQuanLy (cccd);

alter table DonKhieuNai
add constraint fk_DonKhieuNai_cccdKhachHang foreign key (cccdKhachHang) references KhachHang (cccd);

alter table DonKhieuNai
add constraint fk_DonKhieuNai_cccdTongDaiVien foreign key (cccdTongDaiVien) references NhanVienTongDai (cccd);
...
ADD CONSTRAINT fk_MaKhuyenMai_DonMonAn FOREIGN KEY (maDon) REFERENCES DonMonAn (maDon);

ALTER TABLE MaKhuyenMai
ADD CONSTRAINT fk_MaKhuyenMai_maChiNhanh FOREIGN KEY (maChiNhanh) REFERENCES ChiNhanh (maChiNhanh);
...
ALTER TABLE SuKienUuDai
ADD CONSTRAINT fk_SuKienUuDai_maChiNhanh FOREIGN KEY (maChiNhanh) REFERENCES ChiNhanh (maChiNhanh);
