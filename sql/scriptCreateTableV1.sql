create table BangLaiXe (cccd varchar(255) not null, bangLaiXe varchar(255), primary key(cccd, bangLaiXe)) 
create table BaoGom (maDon varchar(255) not null, maMonAnGioHang varchar(255) not null, primary key(maDon,maMonAnGioHang)) 
...
create table ChuaMonAn (maMonAn varchar(255) not null, maUuDai varchar(255) not null, primary key(maMonAn,maUuDai)) 
create table ChuaThongBao (maThongBao varchar(255) not null, cccd varchar(255) not null, primary key(maThongBao,cccd)) ;
...
create table MonAnThuocVe (maChiNhanh varchar(255) not null, maMonAnChiNhanh varchar(255) not null, primary key(maChiNhanh,maMonAnChiNhanh)) 
...
-- ull, cccd varchar(255), chiNhanh varchar(255), primary key (maNhanVienQuanLy)) 
create table NhanVienThuNgan (cccd varchar(255) not null, maNhanVienThuNgan varchar(255)  not null ,primary key (maNhanVienThuNgan))
...
create table SoDienThoai (cccd varchar(255) not null, soDienThoai varchar(255), primary key (cccd,soDienThoai)) 
create table SoHuu (cccd varchar(255) not null, maMaKhuyenMaiKhachHang varchar(255) not null, primary key (cccd,maMaKhuyenMaiKhachHang)) 
create table SuDung (cccd varchar(255) not null, bienSoXe varchar(255) not null, primary key(cccd,bienSoXe)) 
...
create table ThoiGianSuKien (maUuDai varchar(255) not null, thoiGianSuKien varchar(255),  primary key(maUuDai,thoiGianSuKien)) 
