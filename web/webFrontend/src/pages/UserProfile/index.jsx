...
import pictureProfile from "../../assets/ThuyLinhNe.jpg";
        ...
        <form>
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                setEditFormData({ ...editFormData, ho: e.target.value })
              }
            />
          </div>
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                setEditFormData({ ...editFormData, ten: e.target.value })
              }
            />
          </div>
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                setEditFormData({ ...editFormData, ngaySinh: e.target.value })
              }
            />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input
              ...
              onChange={(e) =>
                setEditFormData({ ...editFormData, matKhau: e.target.value })
              }
            />
          ...
          <div className="form-group">
            ...
            {editFormData.confirmPassword &&
              editFormData.confirmPassword !== editFormData.matKhau && (
          ...
          <div className="form-group">
            ...
            <select
              ...
              onChange={(e) =>
                setEditFormData({ ...editFormData, gioiTinh: e.target.value })
              }
            >
