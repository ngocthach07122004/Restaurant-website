      ...
      <div className="card w-100">
        <div className="row">
          <div className="col-md-8 cart">
            <div className="title">
              <div className="row">
                ...
                <div className="col align-self-center text-right text-muted">{cartItems.length} products</div>
              </div>
            </div>
            {cartItems.length === 0 ? (
          ...
          <div className="col-md-4 summary">
            ...
            <hr />
            <div className="row">
              <div className="col" style={{ paddingLeft: 0 }}>TOTAL PRODUCTS</div>
