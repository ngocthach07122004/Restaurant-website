...
const BranchMap = () => {
  ...
  return (
    <MapContainer center={[10.762622, 106.660172]} zoom={12} style={{ height: '600px', width: '100%' }}>
      <TileLayer
        ...
        >
          <Popup>
            <div>
              ...
              />
              <p><strong>Address:</strong> {branch.diaChi}</p>
              <p><strong>Description:</strong> {branch.moTa}</p>
              <p><strong>Status:</strong> {branch.trangThaiHoatDong}</p>
              <p>
                <strong>Open:</strong> {new Date(branch.thoiGianMoCua).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
              </p>
              <p>
